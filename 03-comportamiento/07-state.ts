...
class ProductSelected implements State {
  ...
  insertMoney(): void {
    console.log('%cPor favor seleciona un producto - dinero ya insertado', COLORS.red);
  }
  ...
  dispenseProduct(): void {
    console.log('%cPor favor seleciona un producto - antes de despacharlo', COLORS.red);
  }
...
class DispensingProduct implements State {
  ...
  dispenseProduct(): void {
    console.log('%cProducto despachado, Cambiando estado a EsperandoDinero', COLORS.red);
