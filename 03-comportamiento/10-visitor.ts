...
class ChildVisitor implements Visitor {
  ...
  visitFerrisWheel(ferrisWheel: FerrisWheel): void {
    console.log(`Niño en Casa del Terror: Precio con descuento de $${ ferrisWheel.getPrice() * 0.6}`)
  }
}
...
class AdultVisitor implements Visitor {
  ...
  visitFerrisWheel(ferrisWheel: FerrisWheel): void {
    console.log(`Adulto en Casa del Terror: Precio con descuento de $${ ferrisWheel.getPrice()}`)
  }
}

class SeniorVisitor implements Visitor {
  visitRollerCoaster(rollerCoaster: RollerCoaster): void {
    console.log(`Senior en Montaña Rusa: Precio con descuento de $${ rollerCoaster.getPrice() * 0.85}`)
  }
  visitHauntedHouse(hauntedHouse: HauntedHouse): void {
    console.log(`Senior en Casa del Terror: Precio con descuento de $${ hauntedHouse.getPrice() * 0.85}`)
  }
  visitFerrisWheel(ferrisWheel: FerrisWheel): void {
    console.log(`Senior en Casa del Terror: Precio con descuento de $${ ferrisWheel.getPrice() * 0.85}`)
  }
}
...
function main(){
  ...
  console.log(`Montaña Rusa: ${ attractions[0].getPrice() }`);
  console.log(`Casa del Terror: ${ attractions[1].getPrice() }`);
  console.log(`La Rueda de la fortuna: ${ attractions[2].getPrice() }`);
  console.log('\n\n');
  ...
  console.log('\n%cVisitante Adulto Mayor', COLORS.yellow);
